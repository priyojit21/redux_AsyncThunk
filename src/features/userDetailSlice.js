...
// //create action
// //createAsyncThunk takes a name,and a callback which is async which takes a data, the data is what is passed inside dispatch() and a rejectwithValue is api call fail
...
//     },
//     //it has to be written for createAsyncThunk()
//     extraReducers : {
//         //promise pending
//         [createUser.pending] : (state) => {
//             state.loading = true;
